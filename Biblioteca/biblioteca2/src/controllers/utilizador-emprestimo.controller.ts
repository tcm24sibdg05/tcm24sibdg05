...
export class UtilizadorEmprestimoController {
  ...
  async find(
    ...
    return this.utilizadorRepository.efetuaEmprestimo(id).find(filter);
  }
  ...
  async create(
    ...
    return this.utilizadorRepository.efetuaEmprestimo(id).create(emprestimo);
  }
  ...
  async patch(
    ...
    return this.utilizadorRepository.efetuaEmprestimo(id).patch(emprestimo, where);
  }
  ...
  async delete(
    ...
    return this.utilizadorRepository.efetuaEmprestimo(id).delete(where);
  }
}
