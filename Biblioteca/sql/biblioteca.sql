...
CREATE TABLE `emprestimo` (
  ...
  KEY `emprestimo_ibfk_3_idx` (`codigoISBN`),
  ...
  CONSTRAINT `emprestimo_ibfk_3` FOREIGN KEY (`codigoISBN`) REFERENCES `livro` (`codigoISBN`)
...
INSERT INTO `emprestimo` VALUES (1,'2025-05-26','2025-06-02',NULL,0,1,1,'9781234567897',1),(2,'2025-05-26','2025-06-02',NULL,0,1,1,'1234567890123',1);
...
INSERT INTO `exemplar` VALUES ('1234567890123',1,'Disponível'),('9781234567897',1,'Disponível');
...
INSERT INTO `funcionario` VALUES (1,'Carlos Mendes','Bibliotecário'),(2,'Carlos Mendes','Bibliotecário');
...
INSERT INTO `livro` VALUES ('1234567890123','A Máquina do Tempo','H.G. Wells',1895,'1ª','Ficção Científica'),('9781234567897','A Máquina do Tempo','H.G. Wells',1895,'1ª','Ficção Científica');
...
INSERT INTO `localizacao` VALUES ('1234567890123',1,'B','2','3'),('9781234567897',1,'B','2','3');
...
INSERT INTO `penalizacao` VALUES (1,'Multa','2025-06-10','Atraso na devolução',1),(2,'Multa','2025-06-10','Atraso na devolução',1);
...
INSERT INTO `reserva` VALUES (1,'2025-05-26','10:00:00','2025-06-01',1,'9781234567897',1),(2,'2025-05-26','10:00:00','2025-06-01',1,'1234567890123',1);
...
INSERT INTO `utilizador` VALUES (1,'Joana Silva','Aluno','joana.silva@mail.com'),(2,'Joana Silva','Aluno','joana.silva@mail.com');
...
-- Dump completed on 2025-06-18 17:08:12
